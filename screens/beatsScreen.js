...
import { BeatsCalculator } from "../src/beats/beats";

var PickerItem = Picker.Item;
class BeatsScreen extends Component {
  constructor(props) {
    super(props);
    this.beatsCalculator = new BeatsCalculator();
    this.state = {
      beats: 0,
      // Prima nota
  ...
  beatsUpdate = () => {
    this.state.beats = Math.abs(
      this.beatsCalculator
        .calculate(
  ...
  render() {
    ...
    if (!this.state.secondNoteSelected) this.state.secondNote = this.props.note;
            ...
            >
              ...
              <Switch
                ...
                onValueChange={() => {
                  ...
                  this.state.firstNoteSelected = !this.state.firstNoteSelected;
                }}
              />
            </View>
            <View
